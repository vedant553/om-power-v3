...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-60" aria-hidden="true" style={{ backgroundImage: "linear-gradient(rgba(8,35,16,0.22) 1px, transparent 1px), linear-gradient(90deg, rgba(8,35,16,0.22) 1px, transparent 1px), linear-gradient(rgba(8,35,16,0.10) 1px, transparent 1px), linear-gradient(90deg, rgba(8,35,16,0.10) 1px, transparent 1px)", backgroundSize: "80px 80px, 80px 80px, 16px 16px, 16px 16px" }} />
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice" fill="none">
          <path d="M0 300 Q50 200 100 300 T200 300 T300 300 T400 300 T500 300 T600 300 T700 300 T800 300" stroke="rgba(234,179,8,0.22)" strokeWidth="2" fill="none" strokeDasharray="20 10" className="animate-waveform" style={{ animationDuration: "3s" }} />
          <path d="M0 320 Q50 220 100 320 T200 320 T300 320 T400 320 T500 320 T600 320 T700 320 T800 320" stroke="rgba(8,35,16,0.35)" strokeWidth="1.5" fill="none" strokeDasharray="20 10" className="animate-waveform" style={{ animationDuration: "4s", animationDelay: "1s" }} />
          <path d="M0 280 Q50 380 100 280 T200 280 T300 280 T400 280 T500 280 T600 280 T700 280 T800 280" stroke="rgba(234,179,8,0.10)" strokeWidth="1" fill="none" strokeDasharray="20 10" className="animate-waveform" style={{ animationDuration: "5s", animationDelay: "0.5s" }} />
        </svg>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice" fill="none">
          <path d="M600 0 L600 120 L500 120 L500 250 L400 250" stroke="rgba(8,35,16,0.50)" strokeWidth="1.5" strokeDasharray="6 4" className="animate-circuit-dash" />
          <path d="M800 200 L700 200 L700 350 L620 350" stroke="rgba(8,35,16,0.30)" strokeWidth="1" strokeDasharray="4 6" className="animate-circuit-dash" style={{ animationDuration: "15s" }} />
          <path d="M650 600 L650 480 L550 480 L550 400 L480 400" stroke="rgba(8,35,16,0.40)" strokeWidth="1.5" strokeDasharray="8 4" className="animate-circuit-dash" style={{ animationDuration: "25s" }} />
          <circle cx="600" cy="120" r="3" fill="rgba(234,179,8,0.55)" />
          <circle cx="500" cy="250" r="3" fill="rgba(234,179,8,0.45)" />
          <circle cx="700" cy="200" r="3" fill="rgba(8,35,16,0.50)" />
          <circle cx="550" cy="480" r="3" fill="rgba(234,179,8,0.38)" />
          <rect x="540" y="110" width="20" height="8" rx="1" stroke="rgba(234,179,8,0.40)" strokeWidth="1" fill="none" />
          <rect x="690" y="190" width="20" height="8" rx="1" stroke="rgba(8,35,16,0.40)" strokeWidth="1" fill="none" />
          <rect x="640" y="470" width="20" height="8" rx="1" stroke="rgba(234,179,8,0.30)" strokeWidth="1" fill="none" />
        </svg>
      </div>
      ...
      <div className="container-custom relative z-10 pt-20 pb-8 md:pt-24 md:pb-10 lg:pt-24 lg:pb-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 xl:col-span-7">
            ...
            >
              Smarter Power.<br />
              <span style={{ color: "#eab308" }}>Lower Consumption.</span>
              <br />
              <span style={{ color: "#ffffff" }}>Greater Savings.</span>
            </h1>

            {/* Body */}
            <p
              className="text-base sm:text-lg md:text-xl leading-relaxed mb-6 md:mb-7 max-w-xl animate-fade-in-up"
              style={{ animationDelay: "0.25s", color: "#ffffff", fontWeight: 500 }}
            >
